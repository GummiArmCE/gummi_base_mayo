...
rosrun xacro xacro  ${GUMMIBASEPATH}/xacro/gummi_description.urdf.xacro base:=${GUMMIBASEPATH} ee:=${GUMMIEEPATH} > ${GUMMIBASEPATH}/urdf/gummi_description.urdf

echo "** Creating SRDF file from gummi_base.srdf.xacro and gummi_ee.srdf.xacro."

rosrun xacro xacro  ${GUMMIBASEPATH}/xacro/gummi.srdf.xacro base:=${GUMMIBASEPATH} ee:=${GUMMIEEPATH} > ${GUMMIBASEPATH}/config/gummi.srdf
